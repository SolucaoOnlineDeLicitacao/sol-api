...
RSpec.describe Administrator::Biddings::OngoingsController, type: :controller do
  ...
  describe '#update' do
    ...
    describe 'exposes' do
      ...
      it { expect(controller.bidding.ongoing?).to be_truthy }
    end

    describe 'response' do
      before do
        allow(BiddingsService::Ongoing).
