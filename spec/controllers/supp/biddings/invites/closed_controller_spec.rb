...
RSpec.describe Supp::Biddings::Invites::ClosedController, type: :controller do
  ...
  let!(:biddings) do
    create_list(:bidding, 2, covenant: covenant, modality: :closed_invite,
  ...
  describe '#create' do
    ...
    describe 'JSON' do
      ...
      context 'when created' do
        before do
          allow(Notifications::Invites::Pending).to receive(:call).and_call_original
          post_create
        end
        ...
        describe 'notification' do
          it { expect(Notifications::Invites::Pending).to have_received(:call).with(invite) }
        end
        ...
        it { expect(invite.pending?).to be_truthy }
      end
      ...
      context 'when not created' do
        ...
        describe 'notification' do
          it { expect(Notifications::Invites::Pending).not_to have_received(:call) }
        end
