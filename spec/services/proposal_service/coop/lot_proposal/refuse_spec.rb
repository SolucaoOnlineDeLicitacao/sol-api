...
RSpec.describe ProposalService::Coop::LotProposal::Refuse, type: :service do
  ...
  before do
    ...
    allow(Notifications::Proposals::Lots::CoopRefused).
  ...
  describe '.call' do
    ...
    context 'when success' do
      ...
      it do
        expect(Notifications::Proposals::Lots::CoopRefused).
