...
RSpec.describe EventServices::Proposal::CancelProposal::Accepted, type: :service do
  ...
  describe '.call!' do
    ...
    context 'when return success' do
      ...
      let(:event) { Events::CancelProposalAccepted.where(eventable: proposal, creator: user) }
    ...
    context 'when failure' do
      before do
        allow_any_instance_of(Events::CancelProposalAccepted).
