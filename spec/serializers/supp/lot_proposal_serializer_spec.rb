...
RSpec.describe Supp::LotProposalSerializer, type: :serializer do
  ...
  describe 'attributes' do
    ...
    it { is_expected.to include 'price_total' => object.price_total }
    it { is_expected.to include 'delivery_price' => object.delivery_price }
  ...
  describe 'associations' do
    describe 'lot' do
      let(:serialized_lot) { format_json(Supp::LotSerializer, object.lot) }
