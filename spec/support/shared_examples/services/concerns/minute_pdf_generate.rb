RSpec.shared_examples 'a minute pdf generate' do
  let(:bidding) { create(:bidding) }
  let(:params) { { bidding: bidding, file_type: 'minute' } }
  ...
  describe '.call!' do
    ...
    before do
      allow(minute_template_html_service).to receive(:call).and_return(nil)
